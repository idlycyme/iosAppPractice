...
static NSString * const kConsumerKey       = @"lAmlo3pFN835yCTqcAJdig";
static NSString * const kConsumerSecret    = @"GVcuYkgcedI-e_dsmNw7VRq-aTM";
static NSString * const kToken             = @"MGQEgs7FxXHiLUl554BghZzQap8gdvW8";
static NSString * const kTokenSecret       = @"p2NEtxV1o6zERdL9qAGzt_H4pzQ";
